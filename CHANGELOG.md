...
* meta-balena-rockchip: update local.conf.sample [Mark Corbin]
...
* rename resin-supervisor to balena-supervisor [Alex Gonzalez]

<details>
<summary> Update meta-balena from v2.38.7 to v2.85.5 [Alex Gonzalez] </summary>
...
* Update balena-yocto-scripts from v1.7.1 to v1.14.9 [Alex Gonzalez]
* Rename resin image types to balena [Alex Gonzalez]
...
* Update balena-yocto-scripts to v1.7.0 [Alexandru Costache]

# v2.38.3+rev8
## (2020-05-14)

* README: Update with balena name [Alexandru Costache]
